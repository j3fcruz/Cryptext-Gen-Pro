...
# ---------------------------------------------------------
# 💖 Donate Dialog - Secure Notepad Pro
# ---------------------------------------------------------
# Enterprise-grade donation dialog for user support.
# Compatible with global theme (dark/light) from QSS.
# ---------------------------------------------------------
import os, sys
import webbrowser
...
from app_config.app_config import (
    APP_NAME, APP_VERSION, AUTHOR, APP_DEVELOPER,
    GITHUB_ID, PAYPAL_ID, KOFI_ID, BTC_ID, ETH_ID, HASH_NAME , DONATE_ICON_PATH
)
import resources_rc
